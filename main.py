...
TOKEN = os.getenv('7906767329:AAFoBlW1vTxsnpiAu3ci6eIcFx2ZRM40FU8')
OWNER_ID_STR = os.getenv('6632677860')
ADMIN_ID_STR = os.getenv('7462334993')
YOUR_USERNAME = os.getenv('@NEXUXMANAGER')
UPDATE_CHANNEL = os.getenv('BOTPAYOUTNEXU')
...
YOUR_USERNAME = YOUR_USERNAME or '@NEYUXMANAGER '
